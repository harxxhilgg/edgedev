  ...
  return (
    ...
    >
      <section aria-labelledby="projects-heading">
        <h1 id="projects-heading" className="mt-4 sm:mt-10 text-center gap-x-2 text-2xl sm:text-3xl font-semibold tracking-tight">
          Projects
        </h1>
      </section>

      <p className="mt-4 mb-14 mx-10 sm:mx-0 text-center text-secondary transition-all">
